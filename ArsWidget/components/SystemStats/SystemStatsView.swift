...
struct SystemStatsView: View {
    ...
    var body: some View {
        ...
        .sheet(isPresented: $showAILimitsSetup) {
            aiLimitsSetupSheet
        }
    ...
    private var feedbackSheet: some View {
        VStack(alignment: .leading, spacing: 14) {
            ...
            Text("Опиши идею или проблему. Все предложения читаются, а поддержка помогает быстрее расставлять приоритеты.")
    ...
    private var aiLimitsSetupSheet: some View {
        VStack(alignment: .leading, spacing: 14) {
