...
struct ArsWidgetLargeButtons: View {
    var action: () -> Void
    var icon: Image
    var title: String
    var body: some View {
...
struct ArsWidgetExtrasMenu : View {
    @ObservedObject var vm: ArsWidgetViewModel
