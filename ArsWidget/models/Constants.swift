...
let bundleIdentifier = Bundle.main.bundleIdentifier ?? "com.staroschuk.arswidget"
...
extension Defaults.Keys {
    ...
    static let releaseName = Key<String>("releaseName", default: "arsansara ☯")
    ...
    // MARK: Shelf
    static let shelfEnabled = Key<Bool>("arsWidgetShelf", default: true)
    ...
    static let remindersPrimaryListID = Key<String?>("remindersPrimaryListID", default: nil)
    static let remindersSecondaryListID = Key<String?>("remindersSecondaryListID", default: nil)
