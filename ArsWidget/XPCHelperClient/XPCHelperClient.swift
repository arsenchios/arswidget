...
final class XPCHelperClient: NSObject {
    ...
    private let serviceName = "com.staroschuk.arswidget.ArsWidgetXPCHelper"

    private var remoteService: RemoteXPCService<ArsWidgetXPCHelperProtocol>?
    ...
    @MainActor
    private func ensureRemoteService() -> RemoteXPCService<ArsWidgetXPCHelperProtocol> {
        ...
        let service = RemoteXPCService<ArsWidgetXPCHelperProtocol>(
            connection: conn,
            remoteInterface: ArsWidgetXPCHelperProtocol.self
        )
    ...
    @MainActor
    private func getRemoteService() -> RemoteXPCService<ArsWidgetXPCHelperProtocol>? {
        remoteService
    }
